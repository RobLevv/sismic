...
class MicrowaveApplication(tk.Frame):
    def __init__(self, master=None) -> None:
        ...
        statechart = import_from_yaml(Path("microwave.yaml"))
    ...
    def create_widgets(self) -> None:
        ...
        self.w_cooking_start = tk.Button(
            input_frame,
            text="start",
            command=partial(self.send_event, event_name="cooking_start"),
        )
        self.w_cooking_stop = tk.Button(
            input_frame,
            text="stop",
        ...
        self.w_tick = tk.Button(
            clock_frame,
            text="tick",
            command=partial(self.send_event, event_name="timer_tick"),
        )
        ...
        self.w_item_placed = tk.Button(
            weight_frame,
            text="place item",
            command=partial(self.send_event, event_name="item_placed"),
        )
        self.w_item_removed = tk.Button(
            weight_frame,
            text="remove item",
        ...
        self.w_door_opened = tk.Button(
            door_frame,
            text="open door",
            command=partial(self.send_event, event_name="door_opened"),
        )
        self.w_door_closed = tk.Button(
            door_frame,
            text="close door",
